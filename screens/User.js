import { Container, ImageContainer, styles,GradientIconBackground} from '../components/userstyle';
                    ...
                    <LinearGradient
                        ...
                        <View style = {styles.containerFour}>
                            <TouchableOpacity onPress={handlePress}>
                                <Image source = {require('../assets/Cocktail.png')} style = {styles.imageStyle}/>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={handlePress}>
                            ...
                            <TouchableOpacity onPress={handlePress}>
                                <Image source = {require('../assets/Sports Mode.png')} style = {styles.imageStyle}/>
                            </TouchableOpacity>                              
                        </View> 
            </Container>
        </ImageContainer>
